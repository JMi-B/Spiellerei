...
#python #MSSQL-Server #vm #Firewall #Sicherheit #TCP/IP #WindowsServer #powershell
...
####  Einstellungen auf dem WindowsServer anpassen
...
### Fazit
Im Prinzip funktioniert die Verbindung ist aber Extrem unsicher. Drei Baustellen:
- die Firewall des WindowsSever ist ausgeschaltet
- Der sa User auf dem MSSQLServer ist zu mächtig (Der darf und kann alles)
- Username und PW stehen in Plaintext im Pythonscript